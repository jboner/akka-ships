package training.ships.akka_persistence.labs
 ...
 * <p/>
 * Supervisor definition and wiring in the {@link training.ships.akka_persistence.labs.Boot} class.
 * <p/>
...
class EventProcessorFacade extends Actor {
  ...
  def receive: PartialFunction[Any, Unit] = {
    case ReplayEvents =>
      val eventLog: List[AnyRef] = (processor !! GetEventLog).getOrElse(throw new IllegalStateException("Can't access event log"))
